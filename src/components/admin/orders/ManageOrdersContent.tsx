...
export default function ManageOrdersContent({ orders, setOrders, moveDeliveredToHistory }: ManageOrdersContentProps) {
  ...
  const statusColumns = [
    { key: 'pending' as OrderStatus, title: 'Received', color: 'bg-yellow-50 border-yellow-200', textColor: 'text-yellow-800' },
    { key: 'confirmed' as OrderStatus, title: 'In Progress', color: 'bg-blue-50 border-blue-200', textColor: 'text-blue-800' },
    { key: 'preparing' as OrderStatus, title: 'Preparing', color: 'bg-indigo-50 border-indigo-200', textColor: 'text-indigo-800' },
