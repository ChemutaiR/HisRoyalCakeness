...
import { Pencil, Trash2, Plus, X, Clock, Users } from 'lucide-react';
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {recipes.map(recipe => (
                <tr key={recipe.id} className="hover:bg-gray-50 cursor-pointer" onClick={() => handleViewRecipe(recipe)}>
          ...
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-gray-600 text-sm">{selectedRecipe.category}</p>
              </div>
              <button 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-lg font-semibold">{selectedRecipe.servings} people</p>
              </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div>
                <h4 className="text-lg font-semibold mb-4 text-gray-800">Ingredients</h4>
                <div className="space-y-3">
                  {selectedRecipe.ingredients.map((ingredient, index) => (
                    <div key={ingredient.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                      <div className="w-6 h-6 bg-[#c7b8ea] text-black rounded-full flex items-center justify-center text-xs font-semibold">
                        {index + 1}
                      </div>
                      <div className="flex-1">
                        <span className="font-medium text-gray-900">{ingredient.measurement}</span>
              ...
              <div>
                <h4 className="text-lg font-semibold mb-4 text-gray-800">Instructions</h4>
                <div className="space-y-4">
                  {selectedRecipe.instructions.map((instruction, index) => (
                    <div key={instruction.id} className="flex gap-3">
                      <div className="flex-shrink-0 w-8 h-8 bg-[#c7b8ea] text-black rounded-full flex items-center justify-center text-sm font-semibold">
                        {index + 1}
                      </div>
                      <div className="flex-1">
