...
export default function NotesSection({ isAuthenticated, notes, onNotesChange }: NotesSectionProps) {
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        ...
        <div className="p-4 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-600 mb-3">
            Sign in to add notes and special instructions for your cake.
          </p>
  ...
  return (
    <div className="bg-white p-6 rounded-lg border border-gray-200">
      ...
      <p className="text-xs text-gray-500 mb-4">If you have any allergies or preferences you would like to convey, please enter them here.</p>
